...
export function MapHomeScreen(props: Props) {
  const {
    ...
    selectedEventDetail, selectedEventRequests, showChatScreen, chatMessages, chatDraft, isSubmittingJoinRequest,
    onSearchQuery, onSearchCategory, onClearSearch, onOpenCreate, onOpenProfile, onEventPress, onRequestJoin, onRequestDecision,
    onOpenChat, onCloseDetail, onShareEvent, onCloseChat, onChatDraft, onSendMessage,
  } = props;
