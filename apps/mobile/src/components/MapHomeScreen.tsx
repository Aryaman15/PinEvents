...
export function MapHomeScreen(props: Props) {
  ...
  }, [showChatScreen, chatMessages.length]);
    ...
    <View className="flex-1 bg-white">
      <MapLibreGL.MapView mapStyle={mapStyleUrl} style={{ flex: 1 }}>
        ...
        >
          <MapLibreGL.CircleLayer
            ...
            style={{
              circleRadius: 7,
              circleColor: ["case", ["get", "isPrivate"], "#7c3aed", "#2563eb"],
            }}
          />
        </MapLibreGL.ShapeSource>
      </MapLibreGL.MapView>
      ...
      {!!selectedEventDetail && !showChatScreen && (
        <View className="absolute bottom-28 left-4 right-4 rounded-xl bg-white p-4 gap-2">
          ...
          <Text className="text-slate-700" numberOfLines={2}>
          ...
          <View className="flex-row gap-2 mt-2 flex-wrap">
            ...
            <Pressable
              className="bg-slate-800 rounded-lg px-3 py-2"
              onPress={() => onShareEvent(selectedEventDetail)}
            >
        ...
        <View className="absolute inset-0 bg-black/50 p-4 pt-16">
          <View className="flex-1 rounded-2xl bg-white p-4">
            <ScrollView contentContainerStyle={{ rowGap: 10 }}>
              ...
              <Text className="text-slate-500">
                Starts: {formatDateTime(selectedEventDetail.startTime)}
              </Text>
              <Text className="text-slate-500">
                    ...
                    >
                      ...
                      <View className="flex-row gap-2">
                        <Pressable
                          ...
                          onPress={() =>
                            onRequestDecision(request.id, "approved")
                          }
                        >
                        ...
                        <Pressable
                          ...
                          onPress={() =>
                            onRequestDecision(request.id, "rejected")
                          }
                        >
            ...
            <View className="flex-row gap-2 mt-3">
              <Pressable
                className="flex-1 rounded-lg bg-slate-900 px-3 py-3"
                onPress={onCloseEventDetails}
              >
                <Text className="text-center text-white">Close</Text>
              </Pressable>
              {selectedEventDetail.viewer?.role === "admin" && (
                <Pressable
                  className="flex-1 rounded-lg bg-red-600 px-3 py-3"
